...
public class Main {
	...
	private final static int OBJECTIF_DYNAMIQUE = monnaieARendrePD; // Taille de la structure tabulaire gÈnÈrÈe
	/*********************************************************************************************************/
	...
	public static void main(String[] args) {
		...
		// Remarque :  cette composition de piËces est triÈe dans l'ordre inverse des autres pour respecter les conditions d'Èlagage
		...
		*/
		...
		//Il faut prouver ou infirmer qu‚ ¢ôun algorithme glouton est exact pour chaque probleme traite.
